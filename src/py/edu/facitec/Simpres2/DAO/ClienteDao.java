...
public class ClienteDao extends GenericDAO<Cliente> {
	...
	public Cliente verificarCedula(String ci) {
		iniciarTransaccion();
		String sql = "from clientes where UPPER(documento) like :filtro";
	...
	public List<Cliente> filtrarClientes(String filtro) {
		iniciarTransaccion();
		String sql = "from clientes where UPPER(nombre) like :filtro or UPPER(apellido) like :filtro or UPPER(documento) like :filtro order by id";
		Query<Cliente> query = getSession().createQuery(sql);
	...
	public List<Cliente> filtroListadoClientes(String dNombre, String hNombre, String dApellido, String hApellido,
		...
		String sql = "from clientes where UPPER(nombre) BETWEEN :dNombre and :hNombre "
